// code rain: https://github.com/cherieyuu/code-rain/tree/main 
let cvs, ctx, cw, ch;
let fontSize = 18, offsetY, cols;
const textList = [];
const color = {
  gradientCount: 3,
  headColor: "rgba(255, 255, 255, 0.5)",
  bodyColor: "rgba(0, 255, 0, 0.5)",
